function SyrinxTimeline(n, t) {
    var i = this,
        u = i.jQueryel = jQuery(n),
        f = i.options = jQuery.extend({}, i.defaultOptions, i.getObject(u.data("timelineOptions")), t),
        r = [];
    jQuery(f.bands).each(function (n) {
...
SimileAjax.version = "2.2.1", SimileAjax.jQuery = jQuery.noConflict(!0), typeof window.jQuery == "undefined" && (window.jQuery = SimileAjax.jQuery), SimileAjax.Platform.os = {
        isMac: !1,
        isWin: !1,
        isWin32: !1,
        isUnix: !1
    ...
    function () {
    ...
    }(), SimileAjax.DateTime._dateRegexp = new RegExp("^(-?)([0-9]{4})((-?([0-9]{2})(-?([0-9]{2}))?)|(-?([0-9]{3}))|(-?W([0-9]{2})(-?([1-7]))?))?jQuery"), SimileAjax.DateTime._timezoneRegexp = new RegExp("Z|(([-+])([0-9]{2})(:?([0-9]{2}))?)jQuery"), SimileAjax.DateTime._timeRegexp = new RegExp("^([0-9]{2})(:?([0-9]{2})(:?([0-9]{2})(.([0-9]+))?)?)?jQuery"), SimileAjax.DateTime.setIso8601Date = function (n, t) {
    ...
    }, jQuery.fn.syrinxTimeline = function (n) {
        var i = Array.prototype.slice.call(arguments, 1),
            t = this;
        return this.each(function () {
            var r = jQuery(this).data("SyrinxTimeline"),
                u;
            undefined === r ? (u = jQuery(this), r = new SyrinxTimeline(this, n), u.data("SyrinxTimeline", r, this.href)) : r[n] && (t = r[n].apply(r, i))
        }), t
    }, jQuery.extend(SimileAjax.Graphics, {
        bubbleConfig: {
        ...
        createBubbleForContentAndPoint: function (n, t, i, r, u, f) {
            ...
            window.setTimeout(function () {
                ...
                f > 0 && o > f && (o = f, s = r - 25), h = SimileAjax.Graphics.createBubbleForPoint(t, i, r, o, u), document.body.removeChild(n), e.css({
                    ...
                    left: "",
                    top: ""
                }), s > 0 ? (n.style.width = "", jQuery("<div style='width:" + s + "px'/>").appendTo(h.content).append(n)) : e.css("width", r + "px").appendTo(h.content)
            }, 200)
        },
    ...
    }), jQuery.extend(SimileAjax.Graphics._Animation.prototype, {
        run: function () {
            var n = this;
            window.setTimeout(function () {
                n.step()
    ...
    }), jQuery.extend(SimileAjax.Graphics._FontRenderingContext.prototype, {
        dispose: function () {
            this._elmt = null
        },
        update: function () {
        ...
        initialize: function () {
            function n(n) {
                jQuery(n).each(function () {
                    jQuery("<img />").attr("src", Timeline.urlPrefix + "images/" + this).appendTo("body").css("display", "none")
                })
            }
        ...
        n.autoWidth && typeof t.width == "string" && (t.width = t.width.indexOf("%") > -1 ? 0 : parseInt(t.width)), this._timeline = n, this._bandInfo = t, this._index = i, this._locale = "locale" in t ? t.locale : Timeline.getDefaultLocale(), this._timeZone = "timeZone" in t ? t.timeZone : 0, this._labeller = "labeller" in t ? t.labeller : "createLabeller" in n.getUnit() ? n.getUnit().createLabeller(this._locale, this._timeZone) : new Timeline.GregorianDateLabeller(this._locale, this._timeZone), this._theme = t.theme, this._zoomIndex = "zoomIndex" in t ? t.zoomIndex : 0, this._zoomSteps = "zoomSteps" in t ? t.zoomSteps : null, this._dragging = !1, this._changing = !1, this._originalScrollSpeed = 5, this._scrollSpeed = this._originalScrollSpeed, this._onScrollListeners = [], this._orthogonalDragging = !1, this._viewOrthogonalOffset = 0, this._onOrthogonalScrollListeners = [], u = this, this._syncWithBand = null, this._syncWithBandHandler = function () {
            u._onHighlightBandScroll()
        }, this._syncWithBandOrthogonalScrollHandler = function () {
            u._onHighlightBandOrthogonalScroll()
        }, this._selectorListener = function () {
            u._onHighlightBandScroll()
        }, s = jQuery("<div class='timeline-band-input'/>").appendTo(this._timeline.getContainer()), this._keyboardInput = jQuery("<div class='timeline-band-nofocus' tabindex='-1' /><input type='text'/>").appendTo(s).on("keydown", function (n) {
            r._onKeyDown(n)
        }).on("keyup", function (n) {
            r._onKeyUp(n)
        ...
        jQuery(this._div).on("dblclick", function (n) {
            r._onDblClick(n)
        });
        jQuery(this._div).on("mousedown", function (n) {
            r._onMouseDown(n)
        });
        jQuery(this._div).on("touchstart", function (n) {
            r._onTouchStart(n)
        });
        jQuery(this._div).on("touchmove", function (n) {
            r._onTouchMove(n)
        });
        jQuery(this._div).on("click", function (n) {
            n.srcElement.tagName == "IMG" || jQuery(n.srcElement).hasClass("timeline-event-label") || r._keyboardInput.get(1).focus()
        });
        jQuery("body").on("mousemove", function (n) {
            r._onMouseMove(n)
        });
        jQuery("body").on("mouseout", function (n) {
            r._onMouseOut(n)
        });
        jQuery("body").on("mouseup", function (n) {
            r._onMouseUp(n)
        });
        if (o = this._theme != null ? this._theme.mouseWheel : "scroll", o === "zoom" || o === "scroll" || this._zoomSteps)
            if (SimileAjax.Platform.browser.isFirefox) jQuery(this._div).on("DOMMouseScroll", function (n) {
                r._onMouseScroll(n)
            });
            else jQuery(this._div).on("mousewheel", function (n) {
                r._onMouseScroll(n)
            });
        ...
        }, this._eventSource.addListener(this._eventListener)), this._eventPainter = t.eventPainter, this._eventTracksNeeded = 0, this._eventTrackIncrement = 0, t.eventPainter.initialize(this, n), this._decorators = ("decorators" in t) ? t.decorators : [], f = 0; f < this._decorators.length; f++) this._decorators[f].initialize(this, n);
        ...
        createLayerDiv: function (n, t) {
            var i = jQuery("<div classname='" + t + " timeline-band-layer' style='z-index:" + n + "'/>").appendTo(this._innerDiv),
                r = jQuery("<div className='timeline-band-layer-inner' style='cursor:" + (SimileAjax.Platform.browser.isIE ? "move" : "-moz-grab") + "'/>").appendTo(i);
            return r.hide()
        },
        ...
        _onMouseUp: function () {
            ...
            this._keyboardInput.get(0).focus(), this._bounceBack()
        },
        ...
        _onMouseScroll: function (n) {
            var i, t, r, u, f, e;
            n = n.originalEvent, i = new Date, i = i.getTime(), (!this._lastScrollTime || i - this._lastScrollTime > 50) && (this._lastScrollTime = i, t = 0, n.wheelDelta ? t = n.wheelDelta / 120 : n.detail && (t = -n.detail / 3), r = this._theme.mouseWheel, this._zoomSteps || r === "zoom" ? (u = SimileAjax.DOM.getEventRelativeCoordinates(n, innerFrame), t != 0 && (t > 0 && (f = !0), t < 0 && (f = !1), this._timeline.zoom(f, u.x, u.y, innerFrame))) : r === "scroll" && (e = 50 * (t < 0 ? -1 : 1), this._moveEther(e))), n.stopPropagation && n.stopPropagation(), n.cancelBubble = !0, n.preventDefault && n.preventDefault(), n.returnValue = !1
        },
        _onDblClick: function (n) {
            var t = n.srcElement ? n.srcElement : n.target,
                i, r;
            jQuery(t).hasClass("timeline-band-inner") || (t = jQuery(t).parents(".timeline-band-inner").get(0)), i = SimileAjax.DOM.getEventRelativeCoordinates(n, t), r = i.x - (this._viewLength / 2 - this._viewOffset), this._autoScroll(-r)
        },
        _onTouchStart: function (n) {
            if (n.originalEvent.touches.length == 1) {
                var t = n.originalEvent.changedTouches[0];
                this._dragX = t.clientX, this._dragY = t.clientY
            }
        },
        _onTouchMove: function (n) {
            if (n.originalEvent.touches.length == 1) {
                n.preventDefault();
                var t = n.originalEvent.changedTouches[0],
                    i = t.clientX - this._dragX,
                    r = t.clientY - this._dragY;
                this._dragX = t.clientX, this._dragY = t.clientY, this._moveEther(this._timeline.isHorizontal() ? i : r), this._positionHighlight(), this._fireOnScroll(), this._setSyncWithBandDate()
            }
        },
    ...
    }, jQuery.extend(Timeline.SpanHighlightDecorator.prototype, {
    ...
    }, jQuery.extend(Timeline.PointHighlightDecorator.prototype, {
        initialize: function (n, t) {
            this._band = n, this._timeline = t, this._layerDiv = null
        },
        paint: function () {
            var t, i;
            if (this._layerDiv != null && this._band.removeLayerDiv(this._layerDiv), this._layerDiv = jQuery(this._band.createLayerDiv(10)).show().get(0), t = this._band.getMinDate(), i = this._band.getMaxDate(), this._unit.compare(this._date, i) < 0 && this._unit.compare(this._date, t) > 0) {
    ...
    }, jQuery.extend(Timeline.GregorianEtherPainter.prototype, {
        initialize: function (n, t) {
    ...
    }, jQuery.extend(Timeline.HotZoneGregorianEtherPainter.prototype, {
        initialize: function (n, t) {
            this._band = n, this._timeline = t, this._backgroundLayer = n.createLayerDiv(0).addClass("timeline-ether-bg").show().get(0), this._markerLayer = null, this._lineLayer = null;
            var i = "align" in this._params && this._params.align != undefined ? this._params.align : this._theme.ether.interval.marker[t.isHorizontal() ? "hAlign" : "vAlign"],
                r = "showLine" in this._params ? this._params.showLine : this._theme.ether.interval.line.show;
    ...
    }, jQuery.extend(Timeline.YearCountEtherPainter.prototype, {
        initialize: function (n, t) {
            this._band = n, this._timeline = t, this._backgroundLayer = n.createLayerDiv(0).addClass("timeline-ether-bg").show().get(0), this._markerLayer = null, this._lineLayer = null;
    ...
    }, jQuery.extend(Timeline.QuarterlyEtherPainter.prototype, {
        initialize: function (n, t) {
            this._band = n, this._timeline = t, this._backgroundLayer = n.createLayerDiv(0).addClass("timeline-ether-bg").show().get(0), this._markerLayer = null, this._lineLayer = null;
            var i = "align" in this._params ? this._params.align : this._theme.ether.interval.marker[t.isHorizontal() ? "hAlign" : "vAlign"],
                r = "showLine" in this._params ? this._params.showLine : this._theme.ether.interval.line.show;
    ...
    }, jQuery.extend(Timeline.Event.prototype, {
        getID: function () {
            return this._id
        },
        isInstant: function () {
        ...
        fillInfoBubble: function (n, t) {
            ...
            u != null && t.event.bubble.imageStyler(jQuery("<img src='" + u + "'/>").appendTo(n).get(0)), t.event.bubble.titleStyler(jQuery("<div>" + (r ? "<a href='" + r + "'>" : "") + f + (r ? "<\/a>" : "") + "<\/div>").appendTo(n).get(0)), t.event.bubble.bodyStyler(jQuery("<div>" + this.getDescription() + "<\/div>").appendTo(n).get(0))
        }
    ...
    }, jQuery.extend(Timeline.OriginalEventPainter.prototype, {
        initialize: function (n, t) {
        ...
        _prepareForPainting: function () {
            var n = this._band,
                t;
            this._backLayer == null && (this._backLayer = this._band.createLayerDiv(0, "timeline-band-events").css("visibility", "hidden").show().get(0), t = document.createElement("span"), t.className = "timeline-event-label", this._backLayer.appendChild(t), this._frc = SimileAjax.Graphics.getFontRenderingContext(t)), this._frc.update(), this._tracks = [], this._highlightLayer != null && n.removeLayerDiv(this._highlightLayer), this._highlightLayer = n.createLayerDiv(105, "timeline-band-highlights").get(0), this._lineLayer != null && n.removeLayerDiv(this._lineLayer), this._lineLayer = n.createLayerDiv(110, "timeline-band-lines").get(0), this._eventLayer != null && n.removeLayerDiv(this._eventLayer), this._eventLayer = n.createLayerDiv(115, "timeline-band-events").get(0)
        },
        ...
        showBubble: function (n) {
            var t = this._eventIdToElmt[n.getID()],
                i;
            t && (i = SimileAjax.DOM.getPageCoordinates(t), this._showBubble(i.left + t.offsetWidth / 2, i.top + t.offsetHeight / 2, n), this._timeline.cancelFocus())
        },
    ...
    }, jQuery.extend(Timeline.OverviewEventPainter.prototype, {
        initialize: function (n, t) {
        ...
        _paintEventTape: function (n, t, i, r, u, f, e, o, s) {
            var c = e.trackOffset + t * e.trackIncrement,
                l = r - i,
                a = e.trackHeight,
                h = jQuery("div class='timeline-small-event-tape" + (s ? " small-" + s : "") + "'/>").css({
                    left: i + "px",
                    width: l + "px",
                    top: c + "px",
                    height: a + "px"
    ...
    }, jQuery.extend(Timeline.DefaultEventSource.prototype, {
    ...
    }, jQuery.extend(Timeline._Impl.prototype, {
        dispose: function () {
        ...
        cancelFocus: function () {
            var n = this;
            jQuery(this.getContainer()).find(".timeline-band-nofocus").focus()
        },
        ...
        zoom: function (n, t, i, r) {
            var e = new RegExp("^timeline-band-([0-9]+)jQuery"),
                u = null,
                f = e.exec(r.id);
