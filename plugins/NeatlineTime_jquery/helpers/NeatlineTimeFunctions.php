...
function queue_timeline_assets()
{
    ...
    queue_js_file('timeline/jquery.timeline');
    $timelineVariables = 'Timeline.urlPrefix="'.dirname(src('jquery.timeline.js', 'javascripts/timeline/')).'/"; '
                           ;
   
    queue_js_string($timelineVariables);
    //queue_js_file('timeline/jquery.timeline');
    queue_css_file('jquery.timeline');
