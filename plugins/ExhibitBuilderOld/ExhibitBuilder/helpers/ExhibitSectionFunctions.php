...
/**
 * Returns an array of thumbs for thumbnail select field in the exhibit section metadata form
 *
 * @param Exhibit, Section
 * @return array of thumbnails made out of items of the pages belonging to the exhibit
 **/
function exhibit_builder_get_section_thumbs_array($exhibit,$section)
{
    $array;

	$items = get_items(array('exhibit' => $exhibit, 'section' => $section));
