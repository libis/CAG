        ...
        <fieldset>
            ...
            <?php
            	if($exhibit->thumbnail){
            		echo "Current thumbnail: <img width='150' src='http://www.hetvirtueleland.be/themes/CAG/images/verhalen_thumbs/".$exhibit->thumbnail."'><br>Choose another thumbnail  ";
            	}
            ?>
            <style>
			...
			<ul class="exhibit-thumbs-list">
				...
				while($folderEntry=$folder->read())
				{
					if($folderEntry == $exhibit->thumbnail)
						echo "<li><input selected='selected' type='radio' name='thumbnail' value='".$folderEntry."' /> <img width='150' src='http://www.hetvirtueleland.be/themes/CAG/images/verhalen_thumbs/".$folderEntry."'></li>";

					else
						if($folderEntry != '.' && $folderEntry != '..')
							echo "<li><input type='radio' name='thumbnail' value='".$folderEntry."' /><img width='150' src='http://www.hetvirtueleland.be/themes/CAG/images/verhalen_thumbs/".$folderEntry."'></li>";
				}
